...
os.chdir("/Users/Ayush.Gupta/Desktop/hackathon")

# Define folder path and file patterns
folder_path = "/Users/Ayush.Gupgta/Desktop/hackathon/Hackathon_data/wind_power_data/"
...
# Write to CSV
master_file.to_csv("merged_file.csv", index=False)
